...
<body>
	...
	<c:if test='${not empty requestScope.boardReportList and fn.length(requestScope.boardReportList) > 0 }'>
		<c:set var='boardReportList' value='${requestScope.boardReportList }' scope='page' />
		<script>alert('boardReportList existing!');</script>
		
		<div>${boardReportList[0].rContent }</div>
	</c:if>
