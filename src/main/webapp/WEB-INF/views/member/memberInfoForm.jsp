	...
	<div class='container'>
		<div class='container' id='memberModifyForm'>
			<form class='form' name='joinFrm' id='joinFrm' action='#joinAction' method='post' enctype='multipart/form-data'>
				...
				<div class='form-group'>
					<input class='form-control' type='text' id='userName' name='userName' value='${vo.userName }' placeholder='이름 입력' readonly="readonly" />
				...
				<div class='form-group'>
					<%
						String dir = "";
						String fileName = "";
						if (((MemberVo)request.getAttribute("memberVo")).getPhoto() != null) { // 전달된 vo 객체에 photo 가 존재한다면(없다면 빈 문자열 세팅)
							dir = ""; // 파일이 저장된 디렉토리
